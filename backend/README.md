...
## Project Structure
    ...
    ├── testing_datacapture_38753  # Django project configurations
...
1. Clone this repo and `cd testing_datacapture_38753`
...
2. Clone this repo and `cd testing_datacapture_38753`
